...
def get_length(frame,species,folder_path):
    ...
    if "マイワシ" in species:
        ...
        thin_point_frame = maiwashi.get_thin_point(trimmed_frame.copy(),contour,x_tail,folder_path)
    ...
    if "カタクチイワシ(小)" in species:
        ...
        thin_point_frame = katakuchiiwashi_small.get_thin_point(trimmed_frame.copy(),contour,x_tail,folder_path)
    ...
    if "カタクチイワシ" in species:
        ...
        thin_point_frame = katakuchiiwashi.get_thin_point(trimmed_frame.copy(),contour,x_tail,folder_path)
